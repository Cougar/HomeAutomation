...
typedef uint8_t Bool;
    ...
    // ----------
#ifndef F_CPU
#  error  You must define F_CPU in "config.h" file
#endif
    // ----------
#ifndef CAN_BAUDRATE
...
#define CAN_AUTOBAUD    0
    // ----------
#if F_CPU == 16000000UL             //!< Fclkio = 16 MHz, Tclkio = 62.5 ns
...
#elif F_CPU == 12000000UL           //!< Fclkio = 12 MHz, Tclkio = 83.333 ns
...
#elif F_CPU == 8000000UL              //!< Fclkio = 8 MHz, Tclkio = 125 ns
#   if   CAN_BAUDRATE == 100       //!< -- 100Kb/s, 16x Tscl, sampling at 75%
...
#else
#   error This F_CPU value is not in "can_drv.h" file
#endif
    // ----------
...
#error CAN auto baudrate not implemented
...
#define DLC         (DLC0)                                               //! Data Length Coding
    // ----------
#define BRP_MIN     1       //! Prescaler of F_CPU (TQ generation)
#define BRP_MAX     64
