...
* 5/3/09	Revised to allow Random Read with more than one address byte. Made buffer
*				length 128 data bytes. -jkl
* 
****************************************************************************/
...
****************************************************************************/
#define TWI_BUFFER_SIZE 131   // Slave Address + Memory start address (2 bytes) + 128 data bytes (message size)

// For 4MHz clock, data rate will be 100Kbps with 0x0C.
// Using 0x0C and an 8MHz clock, data rate will be 200Kbps. If only 100Kbps is required,
//	change this value t0 0x20.
...
void TWI_Start_Random_Read( unsigned char * , unsigned char, unsigned char );
