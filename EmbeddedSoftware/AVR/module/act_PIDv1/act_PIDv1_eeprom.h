#ifndef ACT_PIDV1_EEPROM
#define ACT_PIDV1_EEPROM
...
// ----------------------------------------------------------------
	...
	#define EEDATA 			(uint8_t*)&eeprom_act_PIDv1.Data
	#define EEDATA16		(uint16_t*)&eeprom_act_PIDv1.Data
	#define EEDATA32		(uint32_t*)&eeprom_act_PIDv1.Data
	#define EEDATA_CALC_CRC		eeprom_crc8((uint8_t*)&eeprom_act_PIDv1.Data,sizeof(struct act_PIDv1_Data))
	...
	#define EEDATA_UPDATE_CRC	eeprom_update_byte((uint8_t*)&eeprom_act_PIDv1.crc,eeprom_crc8((uint8_t*)&eeprom_act_PIDv1.Data,sizeof(struct act_PIDv1_Data)))
#else
	#define EEDATA_UPDATE_CRC	eeprom_write_byte((uint8_t*)&eeprom_act_PIDv1.crc,eeprom_crc8((uint8_t*)&eeprom_act_PIDv1.Data,sizeof(struct act_PIDv1_Data)))
#endif

	#define EEDATA_OK		EEDATA_CALC_CRC == EEDATA_STORED_CRC
	#define EEDATA_STORED_CRC 	eeprom_read_byte((uint8_t*)&eeprom_act_PIDv1.crc)
	
	struct eeprom_act_PIDv1{
		struct act_PIDv1_Data Data;
		uint8_t crc;
	};
	extern struct eeprom_act_PIDv1 EEMEM eeprom_act_PIDv1;
