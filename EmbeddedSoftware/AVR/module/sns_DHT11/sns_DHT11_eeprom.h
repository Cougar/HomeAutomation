#ifndef SNS_DHT11_EEPROM
#define SNS_DHT11_EEPROM
...
// ----------------------------------------------------------------
	...
	#define EEDATA 			(uint8_t*)&eeprom_sns_DHT11.Data
	#define EEDATA16		(uint16_t*)&eeprom_sns_DHT11.Data
	#define EEDATA32		(uint32_t*)&eeprom_sns_DHT11.Data
	#define EEDATA_CALC_CRC		eeprom_crc8((uint8_t*)&eeprom_sns_DHT11.Data,sizeof(struct sns_DHT11_Data))
	...
	#define EEDATA_UPDATE_CRC	eeprom_update_byte((uint8_t*)&eeprom_sns_DHT11.crc,eeprom_crc8((uint8_t*)&eeprom_sns_DHT11.Data,sizeof(struct sns_DHT11_Data)))
#else
	#define EEDATA_UPDATE_CRC	eeprom_write_byte((uint8_t*)&eeprom_sns_DHT11.crc,eeprom_crc8((uint8_t*)&eeprom_sns_DHT11.Data,sizeof(struct sns_DHT11_Data)))
#endif

	#define EEDATA_OK		EEDATA_CALC_CRC == EEDATA_STORED_CRC
	#define EEDATA_STORED_CRC 	eeprom_read_byte((uint8_t*)&eeprom_sns_DHT11.crc)
	
	struct eeprom_sns_DHT11{
		struct sns_DHT11_Data Data;
		uint8_t crc;
	};
	extern struct eeprom_sns_DHT11 EEMEM eeprom_sns_DHT11;
