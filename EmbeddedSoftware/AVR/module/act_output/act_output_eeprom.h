...
// ----------------------------------------------------------------
	...
	#define EEDATA32		(uint32_t*)&eeprom_act_output.Data
	...
	#define EEDATA_UPDATE_CRC	eeprom_update_byte((uint8_t*)&eeprom_act_output.crc,eeprom_crc8((uint8_t*)&eeprom_act_output.Data,sizeof(struct act_output_Data)))
#else
