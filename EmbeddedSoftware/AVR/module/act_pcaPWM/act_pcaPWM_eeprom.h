#ifndef ACT_PCAPWM_EEPROM
#define ACT_PCAPWM_EEPROM
...
// ----------------------------------------------------------------
	...
	#define EEDATA 			(uint8_t*)&eeprom_act_pcaPWM.Data
	#define EEDATA16		(uint16_t*)&eeprom_act_pcaPWM.Data
	#define EEDATA32		(uint32_t*)&eeprom_act_pcaPWM.Data
	#define EEDATA_CALC_CRC		eeprom_crc8((uint8_t*)&eeprom_act_pcaPWM.Data,sizeof(struct act_pcaPWM_Data))
	...
	#define EEDATA_UPDATE_CRC	eeprom_update_byte((uint8_t*)&eeprom_act_pcaPWM.crc,eeprom_crc8((uint8_t*)&eeprom_act_pcaPWM.Data,sizeof(struct act_pcaPWM_Data)))
#else
	#define EEDATA_UPDATE_CRC	eeprom_write_byte((uint8_t*)&eeprom_act_pcaPWM.crc,eeprom_crc8((uint8_t*)&eeprom_act_pcaPWM.Data,sizeof(struct act_pcaPWM_Data)))
#endif

	#define EEDATA_OK		EEDATA_CALC_CRC == EEDATA_STORED_CRC
	#define EEDATA_STORED_CRC 	eeprom_read_byte((uint8_t*)&eeprom_act_pcaPWM.crc)
	
	struct eeprom_act_pcaPWM{
		struct act_pcaPWM_Data Data;
		uint8_t crc;
	};
	extern struct eeprom_act_pcaPWM EEMEM eeprom_act_pcaPWM;
