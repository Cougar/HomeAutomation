...
typedef enum _PGM_SENSOR_TYPE 	{	
					pstIR=0x0,
					pstTEMP_INSIDE=0x1, pstTEMP_OUTSIDE=0x2, pstTEMP_FREEZER=0x3, pstTEMP_REFRIGERATOR=0x4,pstTEMP_DOOR_OUTSIDE=0x8,
					pstDOOR_FREEZER=0x5, pstDOOR_REFRIGERATOR=0x6,pstDOOR_OUTSIDE=0x09,
					pstBLIND_TR=0x7
				} PGM_SENSOR_TYPE;
