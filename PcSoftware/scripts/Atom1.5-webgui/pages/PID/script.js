...
pages.PID = {
  init: function(pageInstance)
  {
    ...
    {
	pageInstance.pageImageElements["regulatorbild"].find("img").attr('src', pageInstance.picture + '?' + Math.random());
    }
    ...
    */
    ...
    pageInstance.pageImageElements["regulatorbild"] = $("#page-PID-image-template").tmpl({url: pageInstance.picture}).appendTo(pageInstance.pageContentElement).trigger("create");
