...
#ifndef VM_PLUGIN_MQTT_H
#define VM_PLUGIN_MQTT_H
...
{
public:
  typedef boost::shared_ptr<Mqtt> Pointer;
  
  Mqtt(boost::asio::io_service& io_service);
  virtual ~Mqtt();
...
private:
  ...
  typedef std::map<ResourceId, Mqtt*> Resources;
  ...
  static Value Export_SendMessage(const v8::Arguments& args);
};
