...
#define sns_irTransceive_STATE_START_TRANSMIT			(6)
#define sns_irTransceive_STATE_PREPARING_PRONTO			(7)
#define sns_irTransceive_STATE_START_TRANSMIT_PRONTO	(8)
#define sns_irTransceive_STATE_PRONTO_REPEAT			(9)
