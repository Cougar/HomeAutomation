...
void tst_Benchmark_Process(void)
{
	...
	if (Timer_Expired(tst_Benchmark_CanSend_TIMER))
	{
		...
		{
			tst_Benchmark_CanSend_txMsg.Data[0] = (tst_Benchmark_CanSend_Prev>>8)&0xff;
			tst_Benchmark_CanSend_txMsg.Data[1] = tst_Benchmark_CanSend_Prev&0xff;
			tst_Benchmark_CanSend_txMsg.Data[2] = 0; // Implement avarage?
			tst_Benchmark_CanSend_txMsg.Data[3] = 0;
