...
// ----------------------------------------------------------------
	...
	#define EEDATA32		(uint32_t*)&eeprom_<template>.Data
	...
	#define EEDATA_UPDATE_CRC	eeprom_update_byte((uint8_t*)&eeprom_<template>.crc,eeprom_crc8((uint8_t*)&eeprom_<template>.Data,sizeof(struct <template>_Data)))
#else
