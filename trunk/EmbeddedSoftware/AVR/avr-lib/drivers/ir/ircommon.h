...
#define TIM_OVFL_RELOAD_VAL	65536-(12000*CYCLES_PER_US/TIMER_PRESC)		//timeout of 12ms when CYCLES_PER_US is 8 and TIMER_PRESC is 8

#define IR_PROTO_RC5		0
#define IR_RC5_ST_BIT		864*CYCLES_PER_US/TIMER_PRESC		//us
#define IR_RC5_BIT			864*2*CYCLES_PER_US/TIMER_PRESC
