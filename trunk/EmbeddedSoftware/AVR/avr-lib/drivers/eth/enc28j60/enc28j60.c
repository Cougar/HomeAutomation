...
// set CS to 0 = active
#define CSACTIVE ENC28J60_CS_PORT&=~(1<<ENC28J60_CS)
// set CS to 1 = passive
#define CSPASSIVE ENC28J60_CS_PORT|=(1<<ENC28J60_CS)
//
#ifdef ENC28J60_USART_SPI_MODE 
