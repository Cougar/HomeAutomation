...
LDLIBSOPTIONS=-lpthread src/v8/libv8_g.a -lrt
...
${OBJECTDIR}/src/Socket/server.o: src/Socket/server.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Socket/server.o src/Socket/server.cpp
...
${OBJECTDIR}/src/CanNet/canmessage.o: src/CanNet/canmessage.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CanNet/canmessage.o src/CanNet/canmessage.cpp
...
${OBJECTDIR}/src/CanNet/cannetmanager.o: src/CanNet/cannetmanager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CanNet
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CanNet/cannetmanager.o src/CanNet/cannetmanager.cpp

${OBJECTDIR}/src/VM/virtualmachine.o: src/VM/virtualmachine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/VM
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/VM/virtualmachine.o src/VM/virtualmachine.cpp

${OBJECTDIR}/src/VM/commandthread.o: src/VM/commandthread.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/VM
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/VM/commandthread.o src/VM/commandthread.cpp

${OBJECTDIR}/src/singleton.o: src/singleton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/singleton.o src/singleton.cpp

${OBJECTDIR}/src/VM/socketthread.o: src/VM/socketthread.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/VM
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/VM/socketthread.o src/VM/socketthread.cpp

${OBJECTDIR}/src/CanNet/canidtranslator.o: src/CanNet/canidtranslator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CanNet
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CanNet/canidtranslator.o src/CanNet/canidtranslator.cpp

${OBJECTDIR}/src/CanNet/candebug.o: src/CanNet/candebug.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CanNet
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CanNet/candebug.o src/CanNet/candebug.cpp

${OBJECTDIR}/src/Xml/xmlnode.o: src/Xml/xmlnode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Xml
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Xml/xmlnode.o src/Xml/xmlnode.cpp

${OBJECTDIR}/src/Tools/tools.o: src/Tools/tools.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Tools
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Tools/tools.o src/Tools/tools.cpp

${OBJECTDIR}/src/Settings/settings.o: src/Settings/settings.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Settings
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Settings/settings.o src/Settings/settings.cpp

${OBJECTDIR}/src/Socket/asyncsocket.o: src/Socket/asyncsocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Socket
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Socket/asyncsocket.o src/Socket/asyncsocket.cpp
