#ifndef IRCOMMON_H_
#define IRCOMMON_H_
//TODO: Move the protocol specifics to protocols.h.
/*-----------------------------------------------------------------------------
 * Includes
 *---------------------------------------------------------------------------*/
#include <stdio.h>
...
#define TIM_1MS_RELOAD_VAL (65536-(1000*CYCLES_PER_US/TIMER_PRESC))
...
#define IR_RC5_REPETITION	105									//ms	(time between ir frames)
...
#define IR_RC6_REPETITION	1									//ms	(time between ir frames)
...
#define IR_RCMM_REPETITION 158									//ms	(time between ir frames)
...
#define IR_SIRC_REPETITION	40									//ms	(time between ir frames)
...
#define IR_SHARP_REPETITION	55									//ms	(time between ir frames)
...
#define IR_NEC_REPETITION	110									//ms	(time between ir frames)
...
#define IR_SAMS_REPETITION	50									//ms	(time between ir frames)
